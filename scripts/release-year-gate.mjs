...
function buildFit(round, targetYear, rows) {
  ...
  return {
    ...
    method: `Pure passFail eligibility gate on earliest official release year vs ${targetYear}. Passing songs carry NO numeric fit — they are scored purely on music (combinedScore falls back to the raw music score); fails are disqualified. earliestReleaseDate gates; albumReleaseDate is the specific-album date (audit only).`,
    fitScale: {
